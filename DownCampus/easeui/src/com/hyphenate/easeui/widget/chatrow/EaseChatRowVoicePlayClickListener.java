...
public class EaseChatRowVoicePlayClickListener implements View.OnClickListener {
    ...
    public EaseChatRowVoicePlayClickListener(EMMessage message, ImageView v, ImageView
            iv_read_status, BaseAdapter adapter, Activity context) {
    ...
    public void playVoice(String filePath) {
        ...
        try {
            ...
            if (message.direct() == EMMessage.Direct.RECEIVE) {
                ...
                if (!message.isListened() && iv_read_status != null && iv_read_status
