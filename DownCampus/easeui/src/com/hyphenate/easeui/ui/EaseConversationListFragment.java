...
public class EaseConversationListFragment extends EaseBaseFragment {
    ...
    protected RelativeLayout search_bar;
    ...
    protected void initView() {
        ...
        search_bar = (RelativeLayout) getView().findViewById(R.id.search_bar);
    }
    ...
    protected void setUpView() {
        ...
        search_bar.setOnClickListener(new OnClickListener() {
                                          @Override
                                          public void onClick(View v) {
                                              Toast.makeText(getActivity(),"搜索页未完成",Toast.LENGTH_SHORT).show();
                                          }
                                      }
        );
    }
