...
import com.util.calendar.CalendarAdapter;
...
@ContentView(R.layout.home_calendar)
public class CalendarActivity extends Activity implements OnClickListener {
	...
	public void addTextToTopTextView(TextView view) {
		...
		textDate.append(calV.getShowYear()).append("-").append(calV.getShowMonth());
