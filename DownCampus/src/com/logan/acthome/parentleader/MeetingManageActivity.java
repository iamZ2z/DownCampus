...
import com.logan.net.InterfaceRetrofit;
...
public class MeetingManageActivity extends Activity {
    ...
    private void initView() {
        ...
        titlebar.addAction(new TitleBar.TextAction("发布会议") {
            ...
            public void performAction(View view) {
                mIntent = new Intent();
                mIntent.setClass(MeetingManageActivity.this, SendMeetingActivity.class);
    ...
    private void urlmeeting2() {
        ...
        retrofit2.Call<MeetingManagerBean> call= InterfaceRetrofit.meetingManagerService
        ...
        call.enqueue(new retrofit2.Callback<MeetingManagerBean>() {
            ...
            public void onResponse(retrofit2.Call<MeetingManagerBean> call,
                ...
                final MeetingManagerBean body=response.body();
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        mAdapter = new SimpleAdapter(MeetingManageActivity.this, getData2
