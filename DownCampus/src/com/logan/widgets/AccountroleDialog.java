...
public class AccountroleDialog extends Dialog {
    public AccountroleDialog(Context context) {
        super(context);
    }

    public AccountroleDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected AccountroleDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        public AccountroleDialog create() {
            ...
            final AccountroleDialog dialog = new AccountroleDialog(context,R.style.custom_dialog);
